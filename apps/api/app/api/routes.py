...
def get_plan_status(
    ...
    if wallet.credits_expires_at and not is_expired:
        delta = wallet.credits_expires_at - now
        days_until_expiry = delta.days

    return {
        'plan_name': wallet.plan_name or 'free',
        'billing_cycle': wallet.billing_cycle or 'monthly',
        'credits_expires_at': wallet.credits_expires_at.isoformat() if wallet.credits_expires_at else None,
        'days_until_expiry': days_until_expiry,
        'is_expired': is_expired,
        'current_credits': wallet.current_credits,
        'plan_activated_at': wallet.plan_activated_at.isoformat() if wallet.plan_activated_at else None,
    }
