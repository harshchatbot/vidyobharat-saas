...
class VideoRepository:
    ...
    def _to_model(self, data: dict) -> Video:
        model = model_from_fields(
            ...
            tts_provider=data.get('tts_provider', data.get('ttsProvider')),
            tts_resolved_voice=data.get('tts_resolved_voice', data.get('ttsResolvedVoice')),
            tts_provider_message=data.get('tts_provider_message', data.get('ttsProviderMessage')),
            tts_fallback_used=bool(data.get('tts_fallback_used', data.get('ttsFallbackUsed', False))),
