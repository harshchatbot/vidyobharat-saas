...
export function SectionCard({
  ...
  return (
    <details open={defaultOpen} className="group">
      <Card className="overflow-hidden border-[hsl(var(--color-border)/0.72)] bg-[hsl(var(--color-elevated)/0.22)] p-0 shadow-soft backdrop-blur-md">
        <summary className="relative flex cursor-pointer list-none items-start justify-between gap-3 px-4 py-3 marker:content-none sm:px-4.5 sm:py-3">
