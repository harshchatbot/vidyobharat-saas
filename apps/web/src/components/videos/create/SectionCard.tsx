  ...
  return (
    <details open={defaultOpen} className="group">
      <Card className="overflow-hidden border-[hsl(var(--color-border))] bg-[linear-gradient(180deg,hsl(var(--color-surface)),hsl(var(--color-elevated)))] p-0 shadow-soft">
        <summary className="relative flex cursor-pointer list-none items-start justify-between gap-3 px-4 py-4 marker:content-none sm:px-5 sm:py-4.5">
          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              <h2 className="font-heading text-[1rem] font-extrabold tracking-tight text-text sm:text-[1.08rem]">{title}</h2>
        ...
        <div className="border-t border-[hsl(var(--color-border))] bg-[linear-gradient(180deg,hsl(var(--color-surface)/0.7),hsl(var(--color-bg)/0.35))] px-4 py-4 sm:px-5 sm:py-4.5">{children}</div>
      </Card>
    </details>
  );
}
