...
export const TEMPLATE_OPTIONS: TemplateOption[] = [
  ...
  {
    key: 'music-video',
    label: 'Performance / Music Reel',
    description: 'Great for music-led edits, performance energy, and rhythmic short-form visuals.',
    icon: Sparkles,
  ...
  },
  {
    ...
    description: 'Best for product, business, and educational explainers with a clear narrative arc.',
    icon: ScrollText,
  ...
  {
    key: 'character-vlog',
    label: 'Character / Persona Reel',
    description: 'Great for character-led explainers, creator monologues, and persona-driven storytelling.',
    icon: Crown,
  ...
  {
    key: 'asmr-video',
    label: 'Calm / ASMR Reel',
    description: 'Best for calm, sensory-rich content with soft pacing and immersive ambience.',
    icon: WandSparkles,
  ...
  {
    key: 'storyboard',
    label: 'Story / Scene Reel',
    description: 'Best for story reels, top-5s, before-after formats, and structured scene-by-scene content.',
  ...
  {
    key: 'history',
    label: 'History Story Reel',
    description: 'Great for dramatic timelines, turning points, and historical storytelling.',
    icon: Landmark,
  ...
  {
    key: 'mythology',
    label: 'Mythology Story Reel',
    description: 'Great for epic characters, emotional retellings, and mythology-led storytelling.',
    icon: Sparkles,
  ...
  {
    key: 'tech',
    label: 'Tech / Product Explainer',
    description: 'Best for tech explainers, launches, AI tools, and product demos.',
    icon: Cpu,
  ...
  {
    key: 'startup',
    label: 'Founder / Startup Reel',
    description: 'Best for founder stories, startup launches, and pitch-style content.',
    icon: Rocket,
  ...
  {
    key: 'product',
    label: 'High-Converting Ad Reel',
    description: 'Designed for brand-safe promo content and conversion-focused social ads.',
    icon: Package2,
  ...
  {
    key: 'real-estate',
    label: 'Property / Listing Reel',
    description: 'Great for property tours, amenities, and locality-focused listing reels.',
    icon: Building2,
...
export const RESOLUTION_OPTIONS = [
  { value: '720p', label: 'Standard HD', description: 'Best value for most creator reels and fastest to generate.' },
  { value: '1080p', label: 'Premium HD', description: 'Higher fidelity output for important posts and final publishing.' },
] as const;
