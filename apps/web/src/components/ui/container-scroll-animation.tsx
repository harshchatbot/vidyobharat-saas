...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-10 h-[28rem] w-full max-w-5xl rounded-[30px] border-4 border-[hsl(var(--color-muted))] bg-[hsl(var(--color-bg-soft))] p-2 shadow-2xl md:h-[40rem] md:p-6"
    >
