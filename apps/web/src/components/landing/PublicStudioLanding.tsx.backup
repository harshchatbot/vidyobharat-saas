  ...
  return (
    <section className="space-y-8">
      <div className="max-w-3xl">
        ...
        <h2 className="mt-3 bg-gradient-to-r from-[hsl(var(--color-accent-amber))] via-[hsl(var(--color-warning))] to-[hsl(var(--color-accent-amber))] bg-clip-text font-heading text-[2.1rem] font-extrabold tracking-tight text-transparent sm:text-[3rem] sm:leading-[1.04]">
    ...
    <section className="overflow-hidden rounded-[36px] border border-white/[0.08]">
      <LampContainer>
        <div className="mx-auto max-w-3xl px-5 text-center">
          <p className="inline-flex items-center justify-center gap-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-[hsl(var(--color-accent-amber))]">
            <Heart className="h-3.5 w-3.5" />
            Made for Indian creators
          </p>

          <h2 className="mt-4 bg-gradient-to-r from-[hsl(var(--color-accent-amber))] via-[hsl(var(--color-warning))] to-[hsl(var(--color-accent-amber))] bg-clip-text font-heading text-[2.2rem] font-extrabold tracking-tight text-transparent sm:text-[3.4rem] sm:leading-[1.02]">
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 rounded-full bg-[linear-gradient(135deg,hsl(var(--color-accent-amber)),hsl(var(--color-warning)))] px-6 py-3.5 text-base font-semibold text-[hsl(var(--color-accent-contrast))] shadow-[0_18px_60px_hsl(var(--color-accent-amber)/0.32)] transition hover:opacity-95"
            >
              Start free
              <ArrowRight className="h-4 w-4" />
            </Link>
...
export function PublicStudioLanding() {
  return (
    <div className="mesh-bg min-h-screen bg-[radial-gradient(circle_at_20%_15%,hsl(var(--color-accent-amber)/0.2),transparent_32%),radial-gradient(circle_at_82%_12%,hsl(var(--color-warning)/0.16),transparent_30%)] text-text">
