    ...
    <section className="py-24">
      ...
      >
        <motion.article whileHover={{ y: -5 }} transition={{ duration: 0.2, ease: 'easeOut' }} className="group relative md:col-span-2">
          <div className="absolute inset-0 rounded-[var(--radius-lg)] opacity-0 blur-xl transition duration-300 group-hover:opacity-100" style={{ background: `hsl(var(--color-accent-amber) / 0.22)` }} />
          <div className="relative h-full rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-5 shadow-soft">
            <div className="pb-12">
              <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[radial-gradient(circle_at_30%_30%,hsl(var(--color-accent-amber)/0.9),hsl(var(--color-accent-amber)))] text-[hsl(var(--color-accent-contrast))] shadow-soft blur-[0.1px]">
        ...
        <motion.article whileHover={{ y: -5 }} transition={{ duration: 0.2, ease: 'easeOut' }} className="group relative">
          <div className="absolute inset-0 rounded-[var(--radius-lg)] opacity-0 blur-xl transition duration-300 group-hover:opacity-100" style={{ background: `hsl(var(--color-accent-cyan) / 0.22)` }} />
          <div className="relative h-full rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-5 shadow-soft">
            <div className="pb-12">
              <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[radial-gradient(circle_at_30%_30%,hsl(var(--color-accent-cyan)/0.85),hsl(var(--color-accent-cyan)))] text-[hsl(var(--color-accent-contrast))] shadow-soft blur-[0.1px]">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    `radial-gradient(circle at 20% 40%, hsl(var(--color-accent-cyan) / 0.28), transparent 40%), radial-gradient(circle at 80% 60%, hsl(var(--color-accent-cyan) / 0.2), transparent 42%)`,
                }}
              >
                <div className="relative h-full w-full">
                  <span className="absolute left-[18%] top-[48%] h-10 w-1 rounded bg-[hsl(var(--color-accent-cyan)/0.8)]" />
                  <span className="absolute left-[28%] top-[42%] h-14 w-1 rounded bg-[hsl(var(--color-accent-cyan)/0.7)]" />
                  <span className="absolute left-[38%] top-[50%] h-8 w-1 rounded bg-[hsl(var(--color-accent-cyan)/0.8)]" />
                  <span className="absolute left-[48%] top-[38%] h-16 w-1 rounded bg-[hsl(var(--color-accent-cyan)/0.75)]" />
                  <span className="absolute left-[58%] top-[46%] h-11 w-1 rounded bg-[hsl(var(--color-accent-cyan)/0.8)]" />
                  <span className="absolute left-[68%] top-[40%] h-15 w-1 rounded bg-[hsl(var(--color-accent-cyan)/0.7)]" />
                </div>
              </div>
            </div>
        ...
        <motion.article whileHover={{ y: -5 }} transition={{ duration: 0.2, ease: 'easeOut' }} className="group relative">
          <div className="absolute inset-0 rounded-[var(--radius-lg)] opacity-0 blur-xl transition duration-300 group-hover:opacity-100" style={{ background: `hsl(var(--color-accent-pink) / 0.24)` }} />
          <div className="relative h-full rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-surface))] p-5 shadow-soft">
            <div className="pb-12">
              <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[radial-gradient(circle_at_30%_30%,hsl(var(--color-accent-pink)/0.85),hsl(var(--color-accent-pink)))] text-[hsl(var(--color-accent-contrast))] shadow-soft blur-[0.1px]">
        ...
        <motion.article whileHover={{ y: -5 }} transition={{ duration: 0.2, ease: 'easeOut' }} className="group relative md:col-span-2">
          <div className="absolute inset-0 rounded-[var(--radius-lg)] opacity-0 blur-xl transition duration-300 group-hover:opacity-100" style={{ background: `hsl(var(--color-success) / 0.2)` }} />
          <div className="relative h-full rounded-[var(--radius-lg)] border border-[hsl(var(--color-border))] bg-[hsl(var(--color-success)/0.06)] p-5 shadow-soft">
            <div className="pb-12">
              <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[radial-gradient(circle_at_30%_30%,hsl(var(--color-success)/0.85),hsl(var(--color-success)))] text-[hsl(var(--color-accent-contrast))] shadow-soft blur-[0.1px]">
              ...
              <ul className="mt-4 space-y-2">
                <li className="text-sm font-medium text-[hsl(var(--color-text))]">
                  <span className="mr-2 inline-block h-2 w-2 rounded-full bg-[hsl(var(--color-success))]" />Verified Data Controls
                </li>
                <li className="text-sm font-medium text-[hsl(var(--color-text))]">
                  <span className="mr-2 inline-block h-2 w-2 rounded-full bg-[hsl(var(--color-success))]" />Audit-ready Governance
                </li>
              </ul>

              <div className="mt-3 w-fit rounded-[var(--radius-md)] border border-[hsl(var(--color-success)/0.35)] bg-[linear-gradient(145deg,hsl(var(--color-success)/0.18),hsl(var(--color-surface)))] px-3 py-1 text-xs font-bold text-[hsl(var(--color-text))]">
                SECURITY VERIFIED
              </div>
            </div>
