    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-6">
          ...
          <Card className="rangmanch-studio-panel space-y-4 border-none bg-transparent">
            ...
            <div className="grid gap-3 lg:grid-cols-2">
              {orderedPlans.map((plan) => (
                <button
                  ...
                  className={`rounded-[22px] border px-4 py-4 text-left transition duration-200 hover:-translate-y-0.5 ${
                    selectedPlan === plan.key
                      ? 'border-[hsl(var(--color-accent))] bg-[hsl(var(--color-accent)/0.12)] shadow-[var(--shadow-soft)]'
                      : 'border-[hsl(var(--color-border)/0.85)] bg-[hsl(var(--color-bg)/0.5)]'
                  }`}
                >
