...
import { WorkflowStepper } from '@/components/story-ad/WorkflowStepper';
...
export default function StoryAdPage() {
  ...
  const getCurrentCheckpoint = () => {
    ...
    if (!project) {
      ...
      // Show step1 if step1 — only platform selection (category already chosen)
      if (guidedFlowStep === 'step1') {
        return (
          <Step1CategoryPlatform
        ...
        return (
          <Step3ReviewGenerate
            ...
            avatarName={guidedFlowData.avatarName}
    ...
    const checkpointProject = isMockMode
      ? {
          ...
          language: guidedFlowData.briefData?.language ?? project.language,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {loading && (!project || isResumingProject) ? (
          ...
          <>
            {/* Workflow Checkpoint */}
            <div className="mb-12">
              {project && project.workflow_state && (
                <WorkflowStepper workflowState={project.workflow_state} />
              )}
