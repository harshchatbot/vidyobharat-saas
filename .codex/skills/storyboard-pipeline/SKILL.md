...
description: Business logic and rules for RangManchAI storyboard pipeline. Use this skill when working on storyboard ad generation, ad categories, script/storyboard checkpoints, scene state machine, emotion tagging, TTS, lipsync rules, credit rules, and scene-level regeneration.
---
